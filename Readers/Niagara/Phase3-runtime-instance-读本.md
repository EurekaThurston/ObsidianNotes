...
先回答问题 1。`FNiagaraSystemInstance`、`FNiagaraEmitterInstance`、`FNiagaraSystemSimulation` 三个类都是**普通 C++ 类**,不是 [[Wiki/Concepts/UE4/UE4-uobject-系统|UObject]]。
...
- 源摘要:
  - [[Wiki/Sources/Stock/NiagaraSystemInstance]](573 行,中间层)
  - [[Wiki/Sources/Stock/NiagaraEmitterInstance]](238 行,最内层)
  - [[Wiki/Sources/Stock/NiagaraSystemSimulation]](428 行,最外层批量调度)
- Entity 页:
