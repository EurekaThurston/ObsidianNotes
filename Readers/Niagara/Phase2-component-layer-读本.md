...
这套机制的完整展开在 Phase 9 [[Wiki/Sources/Stock/NiagaraScalabilityManager]],本 Phase 只需知道它**通过 friend 访问 + Internal 接口对**来操作 Component。
...
完整展开见 Phase 5 [[Wiki/Sources/Stock/NiagaraScriptExecutionContext]]。
...
- 源摘要:
  - [[Wiki/Sources/Stock/NiagaraComponent]](主肉,741 行)
  - [[Wiki/Sources/Stock/NiagaraActor]](极简)
  - [[Wiki/Sources/Stock/NiagaraFunctionLibrary]](四组 API)
- Entity 页(稳定入口):
  - [[Wiki/Entities/Stock/UNiagaraComponent]]
  - [[Wiki/Entities/Stock/ANiagaraActor]]
  - [[Wiki/Entities/Stock/UNiagaraFunctionLibrary]]
...
- 基础概念:
  ...
  - [[Wiki/Concepts/Niagara/Niagara-vs-cascade]] — `UFXSystemComponent` 基类同源
