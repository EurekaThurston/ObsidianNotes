...
> 本页是 Niagara 学习路径 [[Wiki/Syntheses/UE/Niagara/Niagara-learning-path]] Phase 0 的**主题读本**——详细、精确、满满当当,一次读完即掌握 Phase 1+ 所需的全部前置心智模型,不需要跳转。
>
> 定位与 [[Readers/UE/Niagara/Phase 1 - 从 System 到图源抽象基类|Phase 1 读本]]对偶——Phase 0 建地图,Phase 1 在地图上走路。
>
...
### 2.8 一个典型陷阱:Niagara 的 "Handle.Instance"

> [!warning] Phase 1 必定会踩的坑,先钉死
...
> [!warning] Cascade 和 Niagara 资产不可互换
...
读完 Phase 1 的 [[Readers/UE/Niagara/Phase 1 - 从 System 到图源抽象基类|读本]],你就能回答 Phase 0 开头那个问题了:**"UNiagaraSystem 资产和 FNiagaraSystemInstance 实例差别在哪?"**
...
- [[Wiki/Concepts/UE/UE4-uobject-系统]] — Layer 1 全文(UCLASS/UPROPERTY 宏、前缀、GC、智能指针速查)
- [[Wiki/Concepts/UE/UE4-资产与实例]] — Layer 2 全文(食谱/菜类比、Component 桥、为什么分离)
- [[Wiki/Concepts/UE/Niagara/Niagara-vs-cascade]] — Layer 3 全文(哲学对比、脚本阶段、SIMD 模型、显式/隐式)
- [[Wiki/Concepts/UE/Niagara/Niagara-cpu-vs-gpu模拟]] — Layer 4 全文(VectorVM、Compute Shader、DataInterface 两侧、混合使用)

### 下一 Phase

- [[Readers/UE/Niagara/Phase 1 - 从 System 到图源抽象基类]] — Phase 1 读本
- 原子 Source/Entity 页入口见 [[Wiki/Syntheses/UE/Niagara/Niagara-learning-path]]

### 总图

- [[Wiki/Syntheses/UE/Niagara/Niagara-learning-path]] — 10 阶段学习路径导航
