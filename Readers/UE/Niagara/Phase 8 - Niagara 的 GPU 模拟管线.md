...
> 本页是 Niagara 学习路径 [[Wiki/Syntheses/UE/Niagara/Niagara-learning-path]] Phase 8 的**主题读本**。一次读完掌握 Niagara GPU 流水线:脚本 → compute shader → instance count → sort → draw indirect 的完整链路。本 Phase 是 [[Wiki/Concepts/UE/Niagara/Niagara-cpu-vs-gpu模拟|CPU/GPU 双路径]] 里 GPU 侧的全貌。
>
...
- 源摘要(Source × 13;8.8 `NiagaraEmitterInstanceBatcher` GPU 侧已在 Phase 5.5 覆盖)
  - Shader 编译链:[[Wiki/Sources/Stock/Niagara/NiagaraShared]] / [[Wiki/Sources/Stock/Niagara/NiagaraShader]] / [[Wiki/Sources/Stock/Niagara/NiagaraShaderType]] / [[Wiki/Sources/Stock/Niagara/NiagaraShaderMap]] / [[Wiki/Sources/Stock/Niagara/NiagaraScriptBase]]
  - GPU 运行时基础:[[Wiki/Sources/Stock/Niagara/NiagaraGPUInstanceCountManager]] / [[Wiki/Sources/Stock/Niagara/NiagaraGPUSortInfo]]
  - VertexFactory 家族:[[Wiki/Sources/Stock/Niagara/NiagaraVertexFactory]] / [[Wiki/Sources/Stock/Niagara/NiagaraSpriteVertexFactory]] / [[Wiki/Sources/Stock/Niagara/NiagaraRibbonVertexFactory]] / [[Wiki/Sources/Stock/Niagara/NiagaraMeshVertexFactory]]
  - 排序与间接绘制:[[Wiki/Sources/Stock/Niagara/NiagaraSortingGPU]] / [[Wiki/Sources/Stock/Niagara/NiagaraDrawIndirect]]
  - (CPU 侧 Batcher/Tick:[[Wiki/Sources/Stock/Niagara/NiagaraEmitterInstanceBatcher]] 在 Phase 5)
- 实体(Entity × 5,部分类型做了合并)
  - [[Wiki/Entities/Stock/Niagara/FNiagaraShader]](合并 ShaderType/ShaderMap/ScriptBase/Shared 的 4 个头文件)
  - [[Wiki/Entities/Stock/Niagara/FNiagaraGPUInstanceCountManager]]
  - [[Wiki/Entities/Stock/Niagara/FNiagaraGPUSort]](合并 GPUSortInfo + SortingGPU 2 文件)
  - [[Wiki/Entities/Stock/Niagara/FNiagaraVertexFactory]](合并 Sprite/Ribbon/Mesh 4 文件)
  - [[Wiki/Entities/Stock/Niagara/FNiagaraDrawIndirect]]

### 前置议题

- [[Readers/UE/Niagara/Phase 4 - Niagara 的数据语言]] — `FNiagaraDataBuffer` 的 `GPUBufferFloat/Int/Half`、ParameterStore padding 映射
- [[Readers/UE/Niagara/Phase 5 - Niagara 脚本如何跑起来]] — CPU 脚本执行、GPU Tick 打包、Batcher 主循环
- [[Readers/UE/Niagara/Phase 6 - Niagara 粒子如何变成屏幕像素]] — Renderer 如何持 VertexFactory、Dummy SRV、GPU DynamicData
- [[Readers/UE/Niagara/Phase 7 - 最强扩展点 Data Interface]] — DI 的 GPU shader 参数生成(`FNiagaraDataInterfaceParametersCS`)

### 相关概念

- [[Wiki/Concepts/UE/Niagara/Niagara-cpu-vs-gpu模拟]] — GPU 侧的全貌就是本 Phase

### 下一步 / 导航

- 下一阶段:[[Readers/UE/Niagara/Phase 9 - Niagara 的世界管理与可扩展性]] — World 级全局调度、Scalability、Pool
- 选修进阶:[[Readers/UE/Niagara/Phase 10 - Niagara 的高级特性]] — SimStages 多 pass 和 Grid DI
