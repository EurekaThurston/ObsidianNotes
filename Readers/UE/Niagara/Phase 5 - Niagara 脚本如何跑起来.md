...
> 本页是 Niagara 学习路径 [[Wiki/Syntheses/UE/Niagara/Niagara-learning-path]] Phase 5 的**主题读本**。一次读完掌握 CPU VM 如何 dispatch Niagara 脚本、per-instance DI 机制、GPU 执行上下文与 Tick 打包的形态(GPU 详细等 [[Readers/UE/Niagara/Phase 8 - Niagara 的 GPU 模拟管线|Phase 8]])。
>
...
- Source × 5:[[Wiki/Sources/Stock/Niagara/NiagaraCore]] / [[Wiki/Sources/Stock/Niagara/NiagaraDataInterfaceBase]] / [[Wiki/Sources/Stock/Niagara/NiagaraScriptExecutionContext]] / [[Wiki/Sources/Stock/Niagara/NiagaraScriptExecutionParameterStore]] / [[Wiki/Sources/Stock/Niagara/NiagaraEmitterInstanceBatcher]]
- Entity × 5:[[Wiki/Entities/Stock/Niagara/UNiagaraDataInterfaceBase]] / [[Wiki/Entities/Stock/Niagara/FNiagaraScriptExecutionContext]] / [[Wiki/Entities/Stock/Niagara/FNiagaraComputeExecutionContext]] / [[Wiki/Entities/Stock/Niagara/FNiagaraGPUSystemTick]] / [[Wiki/Entities/Stock/Niagara/NiagaraEmitterInstanceBatcher]]

### 前置议题

- [[Readers/UE/Niagara/Phase 3 - Niagara 的心脏]] — CPU ExecContext 在 EmitterInstance 被引用但未展开
- [[Readers/UE/Niagara/Phase 4 - Niagara 的数据语言]] — ParameterStore 基类、类型系统、SoA DataSet
- [[Wiki/Concepts/UE/Niagara/Niagara-cpu-vs-gpu模拟]] — CPU/GPU 双路径

### 下一步 / 导航

- 下一阶段:[[Readers/UE/Niagara/Phase 6 - Niagara 粒子如何变成屏幕像素]] — 粒子数据 → 像素
- 深入 GPU 侧:[[Readers/UE/Niagara/Phase 8 - Niagara 的 GPU 模拟管线]]
