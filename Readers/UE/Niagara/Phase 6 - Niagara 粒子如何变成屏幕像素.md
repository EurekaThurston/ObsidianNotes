...
> 本页是 Niagara 学习路径 [[Wiki/Syntheses/UE/Niagara/Niagara-learning-path]] Phase 6 的**主题读本**。一次读完掌握 Niagara Renderer 家族:[[Wiki/Concepts/UE/UE4-资产与实例|Asset/Instance]] 对偶、GT→RT 数据流、4 种具体类型(Sprite/Ribbon/Mesh/Light)的能力边界与陷阱。
>
...
- 源摘要(Source × 10)
  - 基类:[[Wiki/Sources/Stock/Niagara/NiagaraRendererProperties]] / [[Wiki/Sources/Stock/Niagara/NiagaraRenderer]]
  - Sprite:[[Wiki/Sources/Stock/Niagara/NiagaraSpriteRendererProperties]] / [[Wiki/Sources/Stock/Niagara/NiagaraRendererSprites]]
  - Ribbon:[[Wiki/Sources/Stock/Niagara/NiagaraRibbonRendererProperties]] / [[Wiki/Sources/Stock/Niagara/NiagaraRendererRibbons]]
  - Mesh:[[Wiki/Sources/Stock/Niagara/NiagaraMeshRendererProperties]] / [[Wiki/Sources/Stock/Niagara/NiagaraRendererMeshes]]
  - Light:[[Wiki/Sources/Stock/Niagara/NiagaraLightRendererProperties]] / [[Wiki/Sources/Stock/Niagara/NiagaraRendererLights]]
- 实体(Entity × 6,Properties/Renderer 合并)
  - [[Wiki/Entities/Stock/Niagara/UNiagaraRendererProperties]] / [[Wiki/Entities/Stock/Niagara/FNiagaraRenderer]]
  - [[Wiki/Entities/Stock/Niagara/UNiagaraSpriteRendererProperties]]
  - [[Wiki/Entities/Stock/Niagara/UNiagaraRibbonRendererProperties]]
  - [[Wiki/Entities/Stock/Niagara/UNiagaraMeshRendererProperties]]
  - [[Wiki/Entities/Stock/Niagara/UNiagaraLightRendererProperties]]

### 前置议题

- [[Readers/UE/Niagara/Phase 2 - Component 层的五职责]] — Component Render Pool、Activate/Deactivate 对 Renderer 的影响
- [[Readers/UE/Niagara/Phase 3 - Niagara 的心脏]] — Emitter Instance 的 `RendererBindings` 参数存储
- [[Readers/UE/Niagara/Phase 4 - Niagara 的数据语言]] — `FNiagaraDataSet` + `FNiagaraDataSetAccessor` 是本 Phase 所有 `GetParticleData*` 的源
- [[Readers/UE/Niagara/Phase 5 - Niagara 脚本如何跑起来]] — CPU 脚本写入粒子后才轮到 Renderer 读

### 相关概念

- [[Wiki/Concepts/UE/UE4-资产与实例]] — Properties/Renderer 正是 Asset/Instance 对偶的又一实例
- [[Wiki/Concepts/UE/Niagara/Niagara-cpu-vs-gpu模拟]] — Light/Ribbon 限 CPU 的根源

### 下一步 / 导航

- 下一阶段:[[Readers/UE/Niagara/Phase 7 - 最强扩展点 Data Interface]] — DI 让脚本吃外部数据
