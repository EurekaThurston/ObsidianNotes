...
> 本页是 Niagara 学习路径 [[Wiki/Syntheses/UE/Niagara/Niagara-learning-path]] **最后一个 Phase** 的主题读本。一次读完掌握 Simulation Stages 多 pass 架构 + Grid 2D/3D 场存储 + NeighborGrid 空间哈希 + Emitter 间数据交互。
>
...
- 源摘要(Source × 6)
  - SimStages 主干:[[Wiki/Sources/Stock/Niagara/NiagaraSimulationStageBase]]
  - RW DI 基类:[[Wiki/Sources/Stock/Niagara/NiagaraDataInterfaceRW]]
  - Grid 家族:[[Wiki/Sources/Stock/Niagara/NiagaraDataInterfaceGrid2DCollection]] / [[Wiki/Sources/Stock/Niagara/NiagaraDataInterfaceGrid2DCollectionReader]] / [[Wiki/Sources/Stock/Niagara/NiagaraDataInterfaceGrid3DCollection]]
  - 空间哈希:[[Wiki/Sources/Stock/Niagara/NiagaraDataInterfaceNeighborGrid3D]]
...
- [[Readers/UE/Niagara/Phase 4 - Niagara 的数据语言]] — DataSet 双缓冲思路是 RW DI 四钩子的前置
- [[Readers/UE/Niagara/Phase 7 - 最强扩展点 Data Interface]] — `UNiagaraDataInterfaceRenderTarget2D` 是首个 RW DI 范例
- [[Readers/UE/Niagara/Phase 8 - Niagara 的 GPU 模拟管线]] §3 `FSimulationStageMetaData` — SimStages 的 shader 侧元数据

### 10 个 Phase 导航

- [[Readers/UE/Niagara/Phase 0 - 上阵前的四层脑内地图]]
- [[Readers/UE/Niagara/Phase 1 - 从 System 到图源抽象基类]]
- [[Readers/UE/Niagara/Phase 2 - Component 层的五职责]]
- [[Readers/UE/Niagara/Phase 3 - Niagara 的心脏]]
- [[Readers/UE/Niagara/Phase 4 - Niagara 的数据语言]]
- [[Readers/UE/Niagara/Phase 5 - Niagara 脚本如何跑起来]]
- [[Readers/UE/Niagara/Phase 6 - Niagara 粒子如何变成屏幕像素]]
- [[Readers/UE/Niagara/Phase 7 - 最强扩展点 Data Interface]]
- [[Readers/UE/Niagara/Phase 8 - Niagara 的 GPU 模拟管线]]
- [[Readers/UE/Niagara/Phase 9 - Niagara 的世界管理与可扩展性]]
- **[[Readers/UE/Niagara/Phase 10 - Niagara 的高级特性]]**(本页,终点)
