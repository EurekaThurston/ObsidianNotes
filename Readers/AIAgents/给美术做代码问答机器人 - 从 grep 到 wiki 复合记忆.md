...
- **agent 数量 vs 质量非线性**:本议题暂按单 agent 设计。若未来需要并行跨三仓搜索,是否该升级到 [[Wiki/Concepts/AIFoundations/Multi-agent|multi-agent]] 架构?拐点在哪里?
...
### 本议题的原子页
- 概念页:[[Wiki/Concepts/AIFoundations/Agentic-grep]] — agentic grep 检索机制 + 破解策略
- 综合页:[[Wiki/Syntheses/AIAgents/Artist-code-qa-bot]] — 项目级落地设计
- 源摘要:[[Wiki/Sources/AIFoundations/Code-retrieval-conversation]]
...
- [[Wiki/Concepts/AIFoundations/Hallucination|幻觉]] — 部署首要防御
- [[Wiki/Concepts/AIFoundations/Agent-skills|Agent Skills]] — Persona 实现路径
- [[Wiki/Concepts/AIFoundations/Multi-agent|Multi-agent / Subagent 架构]] — 未来架构升级路径
- [[Wiki/Syntheses/AIFoundations/Prompt-context-harness-evolution|Prompt → Context → Harness 三段论]] — 方法论母体

### 跨主题联系
- [[Readers/Methodology/从 Memex 到 LLM Wiki|方法论读本]] — Wiki 方法论完整脉络
- [[Readers/AIFoundations/AI 应用生态全景 2026|AI 应用生态读本]] — AI 技术栈背景
- [[Readers/AIFoundations/为什么上下文有限反而必须切多 Agent|Multi-agent 读本]] — 未来升级参考
