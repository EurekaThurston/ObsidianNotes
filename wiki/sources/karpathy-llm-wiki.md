...
- **作者**:[[wiki/entities/karpathy|Andrej Karpathy]]
- **日期**:约 2026 年 4 月
...
- **思想源流**:与 Vannevar Bush 1945 年的 [[wiki/concepts/memex|Memex]] 同源——私人、主动策划、文档间关联本身就是价值。Bush 没解决的"谁来维护"这一问题,LLM 解决了。
...
- [[wiki/concepts/llm-wiki-方法论|LLM Wiki 方法论]] — 本源定义的核心方法
- [[wiki/concepts/rag|RAG]] — 作为对比参照
- [[wiki/concepts/memex|Memex]] — 思想源流
- [[wiki/entities/karpathy|Andrej Karpathy]] — 作者
