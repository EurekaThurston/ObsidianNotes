...
这是一种"**让 LLM 做 bookkeeping,让人做思考**"的知识管理范式,由 [[Wiki/Entities/Methodology/Karpathy|Andrej Karpathy]] 在 2026 年提出(见 [[Wiki/Sources/Methodology/Karpathy-llm-wiki]])。

它和 [[Wiki/Concepts/Methodology/Rag|RAG]] 的区别在于:RAG 每次查询都要重新从原始文档里拼碎片;Wiki 则由 LLM 在每次 ingest 时就把新信息**整合进已有的 wiki**——更新实体页、修订综合、标注矛盾。查询时直接在已整合好的 wiki 上进行,答案也可以沉淀回 wiki,形成复利。
...
- [[Wiki/Concepts/Methodology/Rag|RAG]] — 对比参照(查询时检索 vs. 持续整合)
- [[Wiki/Concepts/Methodology/Memex|Memex]] — 思想源流(Vannevar Bush 1945)
- [[Wiki/Entities/Methodology/Karpathy|Andrej Karpathy]] — 提出者
