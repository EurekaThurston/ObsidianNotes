...
RAG 检索的底层机制是 **[[Wiki/Concepts/AIFoundations/Embedding|Embedding（向量嵌入）]]**：
...
- **对抗幻觉**：把可信资料塞进上下文可以降低 [[Wiki/Concepts/AIFoundations/Hallucination|幻觉]]——AI 有"开卷"可抄，胡编空间变小。
...
- [[Wiki/Concepts/AIFoundations/Hallucination|幻觉]] — RAG 是对抗幻觉的主要机制之一
- [[Wiki/Concepts/AIFoundations/Mcp|MCP]] — 另一条"让 AI 接触外部数据"的路径——RAG 是"把数据塞给 AI"，MCP 是"让 AI 主动去取"
- [[Wiki/Concepts/AIFoundations/Embedding|Embedding 向量嵌入]] — RAG 检索的底层数学
- [[Wiki/Concepts/AIFoundations/Agentic-grep|Agentic Grep]] — 代码域 RAG 的对照面:LLM 自己临场 grep,字面匹配比向量近似更准、零索引维护
