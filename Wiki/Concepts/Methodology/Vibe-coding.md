...
📖 完整脉络见 [[Wiki/Syntheses/AIFoundations/Prompt-context-harness-evolution]]。
...
- [[Wiki/Syntheses/AIFoundations/Prompt-context-harness-evolution]] — 三阶段演进的完整叙事
- [[Wiki/Concepts/AIFoundations/Harness-engineering]] — 演进的第三阶段
- [[Wiki/Concepts/AIFoundations/Ai-agent|AI Agent]] — Harness 阶段的主要执行体
- [[Wiki/Concepts/Methodology/Llm-wiki-方法论|LLM Wiki 方法论]] — Karpathy 另一个"加护栏"的方法论

## 深入阅读

- 主题读本:[[Readers/AIFoundations/AI 应用生态全景 2026]](第九章)
- 扩展综合:[[Wiki/Syntheses/AIFoundations/Prompt-context-harness-evolution]]

## 引用来源

- [[Wiki/Sources/AIFoundations/AI-primer-v2]] (raw: [[Raw/Articles/AI 应用技术发展脉络与核心概念扫盲手册 v2]]) — 第 9.1 节
