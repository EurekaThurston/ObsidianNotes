...
- **数据接口（Data Interface）**：通过 DI 读取外部数据（相机位置、骨骼动画、音频频谱……），详见 [[Wiki/Concepts/Niagara/Niagara-cpu-vs-gpu模拟]]
...
## 相关
- [[Wiki/Concepts/UE4/UE4-资产与实例]] — 两者都遵循资产/实例二元模型
- [[Wiki/Concepts/Niagara/Niagara-cpu-vs-gpu模拟]] — Niagara 的 GPU 能力是与 Cascade 的关键差异之一
- [[Wiki/Syntheses/Niagara/Niagara-learning-path]] — 学习路径（Phase 1 开始读 Niagara 资产类）
