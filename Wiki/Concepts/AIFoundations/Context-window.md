...
**Context Window** 是 [[Wiki/Concepts/AIFoundations/Llm|LLM]] 一次能同时读取和关注的 token 数量上限。类比人的短期记忆——你能记住一页纸，记不住一整本书。
...
- 这就是 [[Wiki/Concepts/AIFoundations/Agent-skills|Agent Skills]] 采用"渐进式披露"的根本动机。
- 也是 [[Wiki/Concepts/AIFoundations/Harness-engineering|Harness Engineering]] 四大支柱之一"上下文管理"的核心问题。
- 也是 [[Wiki/Concepts/AIFoundations/Multi-agent|Multi-agent / Subagent 架构]]存在的**第一性原理**——让每个子 Agent 在一次性干净上下文里干脏活,只返回压缩结论,把有效上下文从单窗口 200K 放大到 N × 200K。
...
- [[Wiki/Concepts/AIFoundations/Llm|LLM]] — 上下文窗口是 LLM 的"视力范围"
- [[Wiki/Concepts/AIFoundations/Agent-skills|Agent Skills]] — 渐进式披露直接对抗 Context Rot
- [[Wiki/Concepts/AIFoundations/Harness-engineering|Harness Engineering]] — "上下文管理"是其四大支柱之一
- [[Wiki/Concepts/AIFoundations/Ai-agent|AI Agent]] — Agent 循环的通用基础
- [[Wiki/Concepts/AIFoundations/Multi-agent|Multi-agent / Subagent]] — Context Rot 是它存在的第一性原理
