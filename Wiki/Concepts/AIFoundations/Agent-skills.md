...
这是 Skills 最巧妙的地方，直接针对 [[Wiki/Concepts/AIFoundations/Context-window|Context Rot]] 这个问题设计。
...
| 维度 | CLAUDE.md | Skills | [[Wiki/Concepts/AIFoundations/Mcp\|MCP]] |
|---|---|---|---|
...
- [[Wiki/Concepts/AIFoundations/Context-window|上下文窗口 & Context Rot]] — 渐进式披露的动因
- [[Wiki/Concepts/AIFoundations/Harness-engineering|Harness Engineering]] — Skills 是支柱一"上下文管理"的核心工具
- [[Wiki/Concepts/AIFoundations/Ai-agent|AI Agent]] — Skills 是给 Agent 挂的知识模块
- [[Wiki/Concepts/AIFoundations/Mcp|MCP]] — 与 Skills 互补：MCP 给工具，Skills 给知识
