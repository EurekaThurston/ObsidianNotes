...
这就是"资产 vs 实例"分离的技术基础，详见 [[Wiki/Concepts/UE/UE4-资产与实例]]。

---

## 相关
- [[Wiki/Concepts/UE/UE4-资产与实例]] — 基于 UObject 的资产/实例二元模型
- [[Wiki/Syntheses/UE/Niagara/Niagara-learning-path]] — 学习路径总览
