...
- **可序列化**：能保存/加载，这是 UObject 系统提供的能力（见 [[Wiki/Concepts/UE/UE4-uobject-系统]]）
...
## 相关
- [[Wiki/Concepts/UE/UE4-uobject-系统]] — UObject 是资产的技术基础
- [[Wiki/Concepts/UE/Niagara/Niagara-vs-cascade]] — Cascade 也有类似的资产/实例模型，但更不透明
- [[Wiki/Syntheses/UE/Niagara/Niagara-learning-path]] — 学习路径总览（Phase 1 开始读具体资产类）
