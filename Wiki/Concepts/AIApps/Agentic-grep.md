...
- [[Wiki/Concepts/AIApps/Hallucination|幻觉]] — "未 grep 到证据不许作答"是核心部署纪律
- [[Wiki/Concepts/AIApps/Ai-agent|AI Agent]] — agentic retrieval 是 Agent 的核心能力之一
- [[Wiki/Syntheses/AIApps/Artist-code-qa-bot|给美术做代码问答机器人]] — 本概念在项目级的具体落地

## 引用来源

- 主题读本(推荐通读):[[Readers/AIApps/给美术做代码问答机器人 - 从 grep 到 wiki 复合记忆]]
- 原子 source:[[Wiki/Sources/AIApps/Code-retrieval-conversation]] (raw: [[Raw/Notes/代码检索与美术问答机器人对话]])
