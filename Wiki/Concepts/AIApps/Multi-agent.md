...
第一次听"多 agent"容易想到多线程并行。但对 [[Wiki/Concepts/AIApps/Llm|LLM]] 而言,**最珍贵的资源不是算力,是上下文窗口**——而上下文有三个病:

1. **[[Wiki/Concepts/AIApps/Context-window|Context Rot]]**:窗口越满,对早期 token 注意力越弱、越矛盾、越忘指令。200K 塞到 150K 常比只填 30K 表现更差。
...
- [[Wiki/Concepts/AIApps/Ai-agent|AI Agent]] — 单 agent 循环;本概念是其在"多 agent"方向上的延伸
- [[Wiki/Concepts/AIApps/Context-window|上下文窗口 & Context Rot]] — 多 agent 存在的根本动机
- [[Wiki/Concepts/AIApps/Harness-engineering|Harness Engineering]] — 多 agent 是 Harness "上下文管理"支柱的最强工具
- [[Wiki/Concepts/AIApps/Agent-skills|Agent Skills]] — 同样以对抗 Context Rot 为动机(渐进式披露)
- [[Wiki/Entities/Claudian|Claudian]] — 拥有 `Agent` 工具的自证案例

## 引用来源

- 主题读本(推荐通读):[[Readers/AIApps/为什么上下文有限反而必须切多 Agent]]
