...
Claudian 的工作方式复刻自 [[Wiki/Entities/Methodology/Karpathy|Andrej Karpathy]] 的 LLM Wiki idea — 详见 [[Wiki/Concepts/Methodology/Llm-wiki-方法论]] 和 [[Readers/Methodology/从 Memex 到 LLM Wiki|方法论读本]]。本仓库本身是该方法论的一次个人化实现。
...
- [[Readers/Methodology/从 Memex 到 LLM Wiki]] — 方法论读本
