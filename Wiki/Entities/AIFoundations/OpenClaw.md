...
- 一头接 [[Wiki/Concepts/AIFoundations/Llm|大语言模型]]
...
- [[Wiki/Concepts/AIFoundations/Ai-agent|AI Agent]] — OpenClaw 是个人本地化的 Agent 实现
- [[Wiki/Concepts/AIFoundations/Mcp|MCP]] — OpenClaw 挂外部工具的标准接口
- [[Wiki/Concepts/AIFoundations/Agent-skills|Agent Skills]] — OpenClaw 可挂的知识模块
