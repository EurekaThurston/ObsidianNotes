...
- [[Wiki/Entities/Stock/UNiagaraDataInterfaceBase]] — 父类(Phase 5)
- [[Wiki/Entities/Stock/FNiagaraSystemInstance]] — `DataInterfaceInstanceData` blob
- [[Wiki/Entities/Stock/FNiagaraScriptExecutionContext]] — VM 调用处(Phase 5)
