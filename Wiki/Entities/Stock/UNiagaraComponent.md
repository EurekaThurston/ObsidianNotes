...
- [[Wiki/Entities/Stock/UNiagaraSystem]] — 引用的 Asset 类型
- [[Wiki/Entities/Stock/ANiagaraActor]] — 把本类封装成 Actor 的 wrapper
- [[Wiki/Entities/Stock/UNiagaraFunctionLibrary]] — 返回本类的 BP 入口
- [[Wiki/Concepts/UE4/UE4-资产与实例]] — 本类是 Asset→Instance 的**承载者**
- [[Wiki/Concepts/Niagara/Niagara-vs-cascade]] — `UFXSystemComponent` 基类与 Cascade 的 `UParticleSystemComponent` 同源
