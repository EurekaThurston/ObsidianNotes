...
- [[Wiki/Entities/Stock/FNiagaraSystemInstance]] — 持有者
- [[Wiki/Entities/Stock/UNiagaraEmitter]] — Asset(CachedEmitter)
- [[Wiki/Entities/Stock/FNiagaraEmitterHandle]] — 关联的 Asset handle
- [[Wiki/Concepts/Niagara/Niagara-cpu-vs-gpu模拟]] — CPU/GPU 分叉在此体现

## 深入阅读

- 源摘要:[[Wiki/Sources/Stock/NiagaraEmitterInstance]]
- 主题读本:[[Readers/Niagara/Phase3-runtime-instance-读本]] § 4
