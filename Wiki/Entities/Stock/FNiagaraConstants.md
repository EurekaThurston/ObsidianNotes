...
- [[Wiki/Entities/Stock/FNiagaraVariable]] — 每个常量都是它
- [[Wiki/Entities/Stock/UNiagaraSystem]] / [[Wiki/Entities/Stock/UNiagaraEmitter]] — 常量命名空间在它们身上体现为 `User.` `System.` `Emitter.` 等分组
