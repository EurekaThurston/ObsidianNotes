...
- [[Wiki/Entities/Stock/UNiagaraScript]] — `Source` 字段指向本类
- [[Wiki/Entities/Stock/UNiagaraEmitter]] — `GraphSource` 字段指向本类
- [[Wiki/Concepts/UE4/UE4-uobject-系统]] — "abstract base in runtime, impl in editor module" 典型模式

## 深入阅读

- 全接口清单 + 设计理由:[[Wiki/Sources/Stock/NiagaraScriptSourceBase]]
- 主题读本(推荐初读):[[Wiki/Readers/Niagara/Phase1-asset-layer-读本]] § 5
