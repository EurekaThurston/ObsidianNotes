...
所有特效逻辑都在 [[Wiki/Entities/Stock/Niagara/UNiagaraComponent]] 和 `FNiagaraSystemInstance` 里。是 Cascade 时代 `AEmitter` 的对位物。
...
- [[Wiki/Entities/Stock/Niagara/UNiagaraComponent]] — 唯一的逻辑字段类型
- [[Wiki/Entities/Stock/Niagara/UNiagaraSystem]] — Component 引用的 Asset
- [[Wiki/Concepts/UE/Niagara/Niagara-vs-cascade]] — 对应 Cascade 的 `AEmitter`

## 深入阅读

- 源摘要:[[Wiki/Sources/Stock/Niagara/NiagaraActor]]
- 主题读本:[[Readers/UE/Niagara/Phase 2 - Component 层的五职责]] § 6
