...
- [[Wiki/Entities/Stock/Niagara/NiagaraEmitterInstanceBatcher]] — 持有者
- [[Wiki/Entities/Stock/Niagara/FNiagaraDrawIndirect]] — 对偶 compute shader
- [[Wiki/Entities/Stock/Niagara/FNiagaraDataBuffer]] — `GPUInstanceCountBufferOffset` 引用本 manager 的 offset

## 深入阅读

- 源:[[Wiki/Sources/Stock/Niagara/NiagaraGPUInstanceCountManager]]
- 读本:[[Readers/UE/Niagara/Phase 8 - Niagara 的 GPU 模拟管线]] § 4
