...
- [[Wiki/Entities/Stock/Niagara/FNiagaraEmitterInstance]] — 持有者(通过 `GPUExecContext` 指针)
- [[Wiki/Entities/Stock/Niagara/FNiagaraGPUSystemTick]] — 每帧被打包进这里
- [[Wiki/Entities/Stock/Niagara/NiagaraEmitterInstanceBatcher]] — RT 调度

## 深入阅读

- 源摘要:[[Wiki/Sources/Stock/Niagara/NiagaraScriptExecutionContext]] § 块 C
- 主题读本:[[Readers/UE/Niagara/Phase 5 - Niagara 脚本如何跑起来]] § 5(Phase 8 将完整展开)
