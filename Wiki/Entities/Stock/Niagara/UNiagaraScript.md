...
- [[Wiki/Entities/Stock/Niagara/UNiagaraScriptSourceBase]] — `Source` 类型
- [[Wiki/Entities/Stock/Niagara/UNiagaraSystem]] — 持有 System 脚本
- [[Wiki/Entities/Stock/Niagara/UNiagaraEmitter]] — 持有粒子 / GPU / EventHandler 脚本
- [[Wiki/Concepts/UE/Niagara/Niagara-cpu-vs-gpu模拟]] — CPU(VectorVM)/GPU(Compute Shader)双形态在此类统一
- [[Wiki/Concepts/UE/Niagara/Niagara-vs-cascade]] — "显式编译字节码" 是相对 Cascade 的质变
- [[Wiki/Concepts/UE/UE4-ddc|DDC]] — `CachedScriptVMId` 直接作为 DDC key,团队编译产物缓存的入口

## 深入阅读

- 全字段清单 + 编译产物三件套详解:[[Wiki/Sources/Stock/Niagara/NiagaraScript]]
- 主题读本(推荐初读):[[Readers/UE/Niagara/Phase 1 - 从 System 到图源抽象基类]] § 4
