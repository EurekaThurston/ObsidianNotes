...
- [[Wiki/Entities/Stock/Niagara/UNiagaraEmitter]] — DI 被 Emitter Asset 引用

## 深入阅读

- 源摘要:[[Wiki/Sources/Stock/Niagara/NiagaraDataInterfaceBase]]
- 主题读本:[[Readers/UE/Niagara/Phase 5 - Niagara 脚本如何跑起来]] § 1(Phase 7 完整展开)
