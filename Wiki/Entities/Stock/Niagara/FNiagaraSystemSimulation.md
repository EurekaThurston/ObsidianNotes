...
- [[Wiki/Entities/Stock/Niagara/FNiagaraSystemInstance]] — 被调度的对象
- [[Wiki/Entities/Stock/Niagara/UNiagaraSystem]] — Asset,身份一部分
- [[Wiki/Entities/Stock/Niagara/UNiagaraComponent]] — `bForceSolo` 开关的上游

## 深入阅读

- 全字段清单 + 代码片段:[[Wiki/Sources/Stock/Niagara/NiagaraSystemSimulation]]
- 主题读本:[[Readers/UE/Niagara/Phase 3 - Niagara 的心脏]] § 5-6
