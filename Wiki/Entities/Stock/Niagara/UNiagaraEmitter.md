...
- [[Wiki/Entities/Stock/Niagara/FNiagaraEmitterHandle]] — 引用方式(`friend` 关系)
- [[Wiki/Entities/Stock/Niagara/UNiagaraScript]] — 脚本字段类型
- [[Wiki/Entities/Stock/Niagara/UNiagaraScriptSourceBase]] — `GraphSource` 类型
- [[Wiki/Concepts/UE/Niagara/Niagara-cpu-vs-gpu模拟]] — `SimTarget` 是分叉源头
- [[Wiki/Concepts/UE/Niagara/Niagara-vs-cascade]] — Merge 是 Niagara 架构升级

## 深入阅读

- 全字段清单 + 代码片段:[[Wiki/Sources/Stock/Niagara/NiagaraEmitter]]
- 主题读本(推荐初读):[[Readers/UE/Niagara/Phase 1 - 从 System 到图源抽象基类]] § 3
