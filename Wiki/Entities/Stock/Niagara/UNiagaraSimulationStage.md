...
- [[Wiki/Entities/Stock/Niagara/UNiagaraDataInterfaceRWBase]] — 常作 iteration source
- [[Wiki/Entities/Stock/Niagara/UNiagaraDataInterfaceGrid2DCollection]] / Grid3D / NeighborGrid3D
- Phase 8.5 `FSimulationStageMetaData` 是 shader 侧元数据

## 深入阅读

- 源:[[Wiki/Sources/Stock/Niagara/NiagaraSimulationStageBase]]
- 读本:[[Readers/UE/Niagara/Phase 10 - Niagara 的高级特性]]
