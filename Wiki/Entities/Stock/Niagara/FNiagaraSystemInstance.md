...
- [[Wiki/Entities/Stock/Niagara/UNiagaraComponent]] — 拥有者(TUniquePtr)
- [[Wiki/Entities/Stock/Niagara/FNiagaraEmitterInstance]] — 持有一组
- [[Wiki/Entities/Stock/Niagara/FNiagaraSystemSimulation]] — 批量调度器
- [[Wiki/Entities/Stock/Niagara/UNiagaraSystem]] — Asset
- [[Wiki/Concepts/UE/UE4-资产与实例]] — 本类是 "Instance" 的典型

## 深入阅读

- 全字段清单 + 代码片段:[[Wiki/Sources/Stock/Niagara/NiagaraSystemInstance]]
- 主题读本:[[Readers/UE/Niagara/Phase 3 - Niagara 的心脏]] § 2-3
