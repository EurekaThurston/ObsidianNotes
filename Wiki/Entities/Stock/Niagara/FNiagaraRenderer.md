...
- [[Wiki/Entities/Stock/Niagara/UNiagaraRendererProperties]] — Asset 对偶
- [[Wiki/Entities/Stock/Niagara/UNiagaraComponent]] — `FNiagaraSceneProxy` 持有本类数组

## 深入阅读

- 源摘要:[[Wiki/Sources/Stock/Niagara/NiagaraRenderer]]
- 主题读本:[[Readers/UE/Niagara/Phase 6 - Niagara 粒子如何变成屏幕像素]] § 3
