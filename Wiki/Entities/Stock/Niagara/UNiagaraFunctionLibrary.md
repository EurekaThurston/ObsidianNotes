...
- [[Wiki/Entities/Stock/Niagara/UNiagaraComponent]] — Spawn 的返回类型
- [[Wiki/Entities/Stock/Niagara/UNiagaraSystem]] — Spawn 的 Template 参数
- [[Wiki/Entities/Stock/Niagara/ANiagaraActor]] — 另一种"静态放置"路径(本类是"动态生成"路径)

## 深入阅读

- 全字段清单 + 代码片段:[[Wiki/Sources/Stock/Niagara/NiagaraFunctionLibrary]]
- 主题读本:[[Readers/UE/Niagara/Phase 2 - Component 层的五职责]] § 5
