...
- [[Wiki/Entities/Stock/Niagara/FNiagaraEmitterHandle]] — `EmitterHandles` 的元素类型
- [[Wiki/Entities/Stock/Niagara/UNiagaraEmitter]] — 被 handle 引用的 Emitter
- [[Wiki/Entities/Stock/Niagara/UNiagaraScript]] — System 脚本类型
- [[Wiki/Concepts/UE/UE4-资产与实例]] — 本类是典型 Asset
- [[Wiki/Concepts/UE/Niagara/Niagara-vs-cascade]] — `UFXSystemAsset` 基类与 Cascade 同源

## 深入阅读

- 全字段清单 + 代码片段:[[Wiki/Sources/Stock/Niagara/NiagaraSystem]]
- 主题读本(推荐初读):[[Readers/UE/Niagara/Phase 1 - 从 System 到图源抽象基类]] § 1
