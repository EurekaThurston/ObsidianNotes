...
- [[Wiki/Entities/Stock/Niagara/FNiagaraSystemInstance]] — `friend class FNiagaraGPUSystemTick`
- [[Wiki/Entities/Stock/Niagara/NiagaraEmitterInstanceBatcher]] — RT 消费者
- [[Wiki/Entities/Stock/Niagara/FNiagaraComputeExecutionContext]] — 被引用

## 深入阅读

- 源摘要:[[Wiki/Sources/Stock/Niagara/NiagaraScriptExecutionContext]] § 块 D
- 主题读本:[[Readers/UE/Niagara/Phase 5 - Niagara 脚本如何跑起来]] § 5(Phase 8 详展)
