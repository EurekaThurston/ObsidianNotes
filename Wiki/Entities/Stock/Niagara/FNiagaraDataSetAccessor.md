...
- [[Wiki/Entities/Stock/Niagara/FNiagaraDataSet]] — 操作对象
- [[Wiki/Entities/Stock/Niagara/FNiagaraVariable]] — 按名字查
- [[Wiki/Entities/Stock/Niagara/FNiagaraTypeDefinition]] — TypeInfo 基于此

## 深入阅读

- 源摘要:[[Wiki/Sources/Stock/Niagara/NiagaraDataSetAccessor]]
- 主题读本:[[Readers/UE/Niagara/Phase 4 - Niagara 的数据语言]] § 6
