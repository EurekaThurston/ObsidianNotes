...
- [[Wiki/Entities/Stock/Niagara/FNiagaraVariable]] — 用本类作身份
- [[Wiki/Entities/Stock/Niagara/FNiagaraTypeLayoutInfo]] — 描述本类在 DataBuffer 里的 byte layout
- [[Wiki/Entities/Stock/Niagara/FNiagaraDataSet]] — 按 TypeDef 组织 component

## 深入阅读

- 源摘要:[[Wiki/Sources/Stock/Niagara/NiagaraTypes]]
- 主题读本:[[Readers/UE/Niagara/Phase 4 - Niagara 的数据语言]] § 2
