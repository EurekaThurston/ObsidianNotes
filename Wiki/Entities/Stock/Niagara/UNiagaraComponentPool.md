...
- [[Wiki/Entities/Stock/Niagara/UNiagaraComponent]] — 被池化的对象(Phase 2)
- [[Wiki/Entities/Stock/Niagara/FNiagaraWorldManager]] — 持有者
- [[Wiki/Entities/Stock/Niagara/UNiagaraFunctionLibrary]] — `SpawnSystemAt*` 用本 pool

## 深入阅读

- 源:[[Wiki/Sources/Stock/Niagara/NiagaraComponentPool]]
