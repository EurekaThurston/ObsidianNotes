...
- [[Wiki/Entities/Stock/Niagara/FNiagaraGPUInstanceCountManager]] — 拥有 tasks 队列
- Phase 6 `FNiagaraRenderer` — 注册 tasks

## 深入阅读

- 源:[[Wiki/Sources/Stock/Niagara/NiagaraDrawIndirect]]
- 读本:[[Readers/UE/Niagara/Phase 8 - Niagara 的 GPU 模拟管线]] § 7
