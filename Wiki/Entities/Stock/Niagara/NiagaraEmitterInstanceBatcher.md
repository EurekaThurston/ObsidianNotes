...
- [[Wiki/Entities/Stock/Niagara/FNiagaraGPUSystemTick]] — 输入的 tick 打包
- [[Wiki/Entities/Stock/Niagara/FNiagaraComputeExecutionContext]] — tick 里引用
- [[Wiki/Entities/Stock/Niagara/FNiagaraSystemSimulation]] — GT 侧 batcher 对位
- `FNiagaraGPUInstanceCountManager` / `FGPUSortManager` — Phase 8 深入

## 深入阅读

- 源摘要:[[Wiki/Sources/Stock/Niagara/NiagaraEmitterInstanceBatcher]]
- 主题读本:[[Readers/UE/Niagara/Phase 5 - Niagara 脚本如何跑起来]] § 6(Phase 8 主战场)
