...
- [[Wiki/Entities/Stock/Niagara/FNiagaraDataBuffer]] — 一帧数据的实际持有者
- [[Wiki/Entities/Stock/Niagara/FNiagaraEmitterInstance]] — 每 Emitter 一个 DataSet
- [[Wiki/Entities/Stock/Niagara/FNiagaraDataSetAccessor]] — 类型安全访问模板
- [[Wiki/Entities/Stock/Niagara/FNiagaraTypeLayoutInfo]] — 布局依据
- [[Wiki/Concepts/UE/Niagara/Niagara-cpu-vs-gpu模拟]]

## 深入阅读

- 源摘要:[[Wiki/Sources/Stock/Niagara/NiagaraDataSet]]
- 主题读本:[[Readers/UE/Niagara/Phase 4 - Niagara 的数据语言]] § 4
