...
- [[Wiki/Entities/Stock/Niagara/UNiagaraScript]] — Asset 侧对位(Phase 1)
- [[Wiki/Entities/Stock/Niagara/FNiagaraComputeExecutionContext]] — runtime 用 shader(Phase 5 `GPUScript_RT`)
- [[Wiki/Entities/Stock/Niagara/UNiagaraDataInterface]] — 通过 `DataInterfaceParameters` 接入

## 深入阅读

- 源 × 4:[[Wiki/Sources/Stock/Niagara/NiagaraShared]] / [[Wiki/Sources/Stock/Niagara/NiagaraShader]] / [[Wiki/Sources/Stock/Niagara/NiagaraShaderType]] / [[Wiki/Sources/Stock/Niagara/NiagaraShaderMap]]
- 读本:[[Readers/UE/Niagara/Phase 8 - Niagara 的 GPU 模拟管线]] § 2-3
