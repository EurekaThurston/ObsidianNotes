...
- [[Wiki/Entities/Stock/Niagara/FNiagaraTypeDefinition]] — 类型身份,本类是其伴生数据
- [[Wiki/Entities/Stock/Niagara/FNiagaraDataSet]] — 按本类的 offset 组织 SoA
- [[Wiki/Entities/Stock/Niagara/FNiagaraVariable]]

## 深入阅读

- 源摘要:[[Wiki/Sources/Stock/Niagara/NiagaraTypes]]
- 主题读本:[[Readers/UE/Niagara/Phase 4 - Niagara 的数据语言]] § 3
