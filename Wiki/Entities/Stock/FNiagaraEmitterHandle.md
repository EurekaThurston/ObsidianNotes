...
- [[Wiki/Entities/Stock/UNiagaraSystem]] — 容器,持有 `TArray<FNiagaraEmitterHandle>`
- [[Wiki/Entities/Stock/UNiagaraEmitter]] — `Instance` 指向类型,声明 `friend struct FNiagaraEmitterHandle`
- [[Wiki/Concepts/UE4/UE4-uobject-系统]] — USTRUCT + UPROPERTY 的反射语义

## 深入阅读

- 全字段清单 + 设计理由:[[Wiki/Sources/Stock/NiagaraEmitterHandle]]
- 线性叙事(推荐初读):[[Wiki/Syntheses/Niagara/Phase1-asset-layer-导读]] § 2
