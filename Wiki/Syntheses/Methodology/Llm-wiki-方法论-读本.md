...
# LLM Wiki 方法论 读本 — 本仓库为什么存在,以及它怎么工作
...
公平地说,RAG **不是一无是处**——它对付 [[Wiki/Concepts/AIApps/Hallucination|幻觉]]有奇效。AI 有"开卷"可抄,胡编空间就变小。这也是为什么 2024-2026 年绝大多数"可信 AI 应用"都建立在 RAG 上。
...
意思是:你给 AI 的不该只是**一句话的指令**,而是一个**完整的信息环境**——相关资料、历史对话、工具、文件、约束。这个判断把从业者焦点从"怎么措辞"转到"怎么搭建 AI 的工作环境",直接催生了 Harness Engineering 这个大主题(参见 [[Wiki/Syntheses/AIApps/Prompt-context-harness-evolution|三段论]])。
...
- [[Wiki/Syntheses/AIApps/Prompt-context-harness-evolution|Prompt → Context → Harness 三段论]] — Karpathy 在 AI 应用方法论演进中的位置,参见该文第 2 阶段
- [[Wiki/Concepts/AIApps/Hallucination|幻觉]] — RAG 对抗幻觉的价值背景
- [[Wiki/Concepts/AIApps/Mcp|MCP]] — 另一条"让 AI 接触外部数据"路径,和 RAG 形成对照
