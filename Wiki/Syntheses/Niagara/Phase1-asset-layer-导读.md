...
created: 2026-04-19
updated: 2026-04-19
tags: [niagara, UE4, learning-path, phase-1, reading-guide, asset]
sources: 5
aliases: [Phase 1 导读, Niagara Asset 层导读]
repo: stock
...
# Phase 1 导读 — Niagara 的资产层

> 本页是 Niagara 学习路径 [[Wiki/Syntheses/Niagara/Niagara-learning-path]] Phase 1 的**线性读物**,从头读到尾即可建立 Niagara Asset 层(System / Emitter / Script)的完整心智模型。
>
> 定位:**教科书章节**,不是参考手册。细节查询请跳到本页最末的 [[#深入阅读]] 索引,走对应的 Source/Entity 原子页。
...
*本导读由 [[Claudian]] 基于 Phase 1 的 5 个原子 Source 页综合生成,2026-04-19。*
