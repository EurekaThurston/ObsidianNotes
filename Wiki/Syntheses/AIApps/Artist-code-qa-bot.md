...
>
> 本方案是 [[Wiki/Concepts/AIApps/Agentic-grep|Agentic Grep]] + [[Wiki/Concepts/Methodology/Llm-wiki-方法论|LLM Wiki 方法论]] 在项目代码场景的具体应用。
...
机制详见 [[Wiki/Concepts/AIApps/Agentic-grep]]。
...
这是 [[Wiki/Concepts/AIApps/Agentic-grep#破解关键词依赖:四路策略|Agentic Grep 破解关键词依赖]]的核心具体化。
...
- **第一性原理**:[[Wiki/Concepts/AIApps/Agentic-grep]] 是检索机制
- **长期记忆**:[[Wiki/Concepts/Methodology/Llm-wiki-方法论]] 是知识沉淀范式
- **架构框架**:[[Wiki/Syntheses/AIApps/Prompt-context-harness-evolution]] 三段论中 Harness 层的具体实例
- **技术栈**:[[Wiki/Concepts/AIApps/Agent-skills]] 是 persona 实现路径之一;[[Wiki/Concepts/AIApps/Multi-agent]] 若需更复杂检索(并行跨仓搜索)可升级
- **部署纪律**:[[Wiki/Concepts/AIApps/Hallucination]] 是首要防御对象
- **既有基础**:CLAUDE.md §9 三 code root 路由规则 + `Wiki/Sources/<repo>/` 源摘要已经是半成品弹药库

## 相关

- [[Wiki/Concepts/AIApps/Agentic-grep|Agentic Grep]] — 检索底层机制
- [[Wiki/Concepts/Methodology/Llm-wiki-方法论|LLM Wiki 方法论]] — 长期记忆框架
- [[Wiki/Concepts/AIApps/Hallucination|幻觉]] — 首要防御对象
- [[Wiki/Concepts/AIApps/Agent-skills|Agent Skills]] — Persona 实现路径
- [[Wiki/Entities/AIApps/OpenClaw|OpenClaw]] — Eureka 同事的类似栈,可参考
- [[Readers/AIApps/给美术做代码问答机器人 - 从 grep 到 wiki 复合记忆]] — 本综合的线性读本版,含 Dithered LOD Transition 贯穿案例

## 引用来源

- [[Wiki/Sources/AIApps/Code-retrieval-conversation]] (raw: [[Raw/Notes/代码检索与美术问答机器人对话]])
