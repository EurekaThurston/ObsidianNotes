...
>
> 本方案是 [[Wiki/Concepts/AIApps/Ai-agent|AI Agent]] + Tool Use + Code Interpreter 在 VFX 贴图生产场景的具体应用,与 [[Wiki/Syntheses/AIApps/Artist-code-qa-bot]] 并列,都属于"美术向 AI 落地"模式族。
...
借鉴 [[Wiki/Syntheses/AIApps/Artist-code-qa-bot#POC 最小路径|Artist-code-qa-bot 的 POC 方法]]:
