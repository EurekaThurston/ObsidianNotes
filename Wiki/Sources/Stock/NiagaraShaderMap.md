...
学习路径 8.4 列它,是因为**学习时需要知道 `FNiagaraShaderMap` 类存在**。但实际声明在 [[Wiki/Sources/Stock/NiagaraShared]] L393。

推测该头文件被规划作公开入口但内容最终并入 `NiagaraShared.h`,stub 保留兼容 include。

## 涉及实体

- [[Wiki/Entities/Stock/FNiagaraShader]](Shader 家族合并页,ShaderMap 在此)
