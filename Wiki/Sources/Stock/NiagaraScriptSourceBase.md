...
- [[Wiki/Entities/Stock/UNiagaraScriptSourceBase]] — 本文件定义的主类
- [[Wiki/Entities/Stock/UNiagaraScript]] — 编译产物;其 `Source` 指向此类
- [[Wiki/Entities/Stock/UNiagaraEmitter]] — `GraphSource` 指向此类
- [[Wiki/Concepts/UE4/UE4-uobject-系统]] — 抽象基类 + editor/runtime 模块分离的典型模式

## 与既有 wiki 的关系

- 补充 [[Wiki/Syntheses/Niagara/Niagara-learning-path]]:Phase 1 完成后,可以清楚看到 **editor 侧图源 → 编译请求 → 字节码 / shader** 的接口边界
- 印证 [[Wiki/Concepts/UE4/UE4-资产与实例]]:Asset 在 editor 下携带额外的 editor-only 信息(图源),cook 后这部分被剥离
