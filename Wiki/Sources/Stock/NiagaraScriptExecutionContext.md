...
- [[Wiki/Entities/Stock/FNiagaraScriptExecutionContext]] — CPU VM 执行上下文
- [[Wiki/Entities/Stock/FNiagaraComputeExecutionContext]] — GPU 执行上下文(Phase 8 详)
- [[Wiki/Entities/Stock/FNiagaraGPUSystemTick]] — GT→RT 的 tick 打包(Phase 8 详)
- [[Wiki/Entities/Stock/FNiagaraEmitterInstance]] — 持有 Spawn/Update ExecContext
- [[Wiki/Entities/Stock/FNiagaraSystemSimulation]] — 持有 System 级 ExecContext
