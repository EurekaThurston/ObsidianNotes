...
- [[Wiki/Entities/Stock/Niagara/FNiagaraSystemInstance]] — 本文件定义的主类
- [[Wiki/Entities/Stock/Niagara/FNiagaraEmitterInstance]] — Instance 持有的 emitter 实例
- [[Wiki/Entities/Stock/Niagara/FNiagaraSystemSimulation]] — Instance 归属的批量调度器
- [[Wiki/Entities/Stock/Niagara/UNiagaraComponent]] — Instance 的拥有者(TUniquePtr)
- [[Wiki/Entities/Stock/Niagara/UNiagaraSystem]] — Instance 对应的 Asset
- [[Wiki/Concepts/UE/UE4-资产与实例]] — 本类是"Instance"的典型
