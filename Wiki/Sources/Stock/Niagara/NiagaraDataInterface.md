...
- **主实体**:[[Wiki/Entities/Stock/Niagara/UNiagaraDataInterface]](本 Source 定义的主基类)
...
- **Phase 10 分支**(RW DI 族,另走 `UNiagaraDataInterfaceRWBase`):见 [[Wiki/Entities/Stock/Niagara/UNiagaraDataInterfaceRWBase]]
...
- [[Wiki/Entities/Stock/Niagara/UNiagaraDataInterface]] — 本文件主类
- [[Wiki/Entities/Stock/Niagara/UNiagaraDataInterfaceBase]] — Phase 5 基类
- [[Wiki/Entities/Stock/Niagara/FNiagaraSystemInstance]] — 持有 DI per-instance data blob
