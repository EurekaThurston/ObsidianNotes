...
- [[Wiki/Entities/Stock/Niagara/UNiagaraSystem]] — 本文件定义的主类
- [[Wiki/Entities/Stock/Niagara/FNiagaraEmitterHandle]] — `EmitterHandles` 元素类型
- [[Wiki/Entities/Stock/Niagara/UNiagaraEmitter]] — 被 handle 引用的 Emitter
- [[Wiki/Entities/Stock/Niagara/UNiagaraScript]] — SystemSpawn/SystemUpdate 脚本类型
- [[Wiki/Concepts/UE/UE4-资产与实例]] — System 是 Asset,Instance 见 Phase 3
- [[Wiki/Concepts/UE/Niagara/Niagara-vs-cascade]] — `UFXSystemAsset` 基类同源于 Cascade

## 与既有 wiki 的关系

- 印证了 [[Wiki/Syntheses/UE/Niagara/Niagara-learning-path]] 的三层架构图:System → EmitterHandle → Emitter → Script
- 印证了 [[Wiki/Concepts/UE/Niagara/Niagara-vs-cascade]] 里 "SystemSpawnScript / SystemUpdateScript 对应 Niagara 的固定执行阶段"
