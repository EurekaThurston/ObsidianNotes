...
- [[Wiki/Entities/Stock/Niagara/FNiagaraFunctionSignature]] — 本文件的核心结构体
- [[Wiki/Entities/Stock/Niagara/FNiagaraDataSetID]] — DataSet 身份
- 大量 enum 分散引用于:[[Wiki/Concepts/UE/Niagara/Niagara-cpu-vs-gpu模拟]](SimTarget)、Phase 2(TickBehavior/AgeUpdateMode)、Phase 3(ExecutionState)
