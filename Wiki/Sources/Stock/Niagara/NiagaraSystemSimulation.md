...
- [[Wiki/Entities/Stock/Niagara/FNiagaraSystemSimulation]] — 本文件定义的主类
- [[Wiki/Entities/Stock/Niagara/FNiagaraSystemInstance]] — 被调度的 instance
- [[Wiki/Entities/Stock/Niagara/UNiagaraSystem]] — Asset,Simulation 身份的一部分
- [[Wiki/Concepts/UE/Niagara/Niagara-vs-cascade]] — Niagara 为性能牺牲黑盒模块化的典型产物
