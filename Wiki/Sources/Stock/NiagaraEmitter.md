...
- `SimTarget`(`ENiagaraSimTarget`,L304):`CPUSim` or `GPUComputeSim` — 这是 [[Wiki/Concepts/Niagara/Niagara-cpu-vs-gpu模拟]] 里的核心分叉字段
...
**Source(editor-only)**
- `GraphSource`(`UNiagaraScriptSourceBase*`,L392):所有此 Emitter 内脚本的共享图源,见 [[Wiki/Sources/Stock/NiagaraScriptSourceBase]]
...
- [[Wiki/Entities/Stock/UNiagaraEmitter]] — 本文件定义的主类
- [[Wiki/Entities/Stock/UNiagaraScript]] — 所有脚本字段的类型
- [[Wiki/Entities/Stock/FNiagaraEmitterHandle]] — 持有 Emitter 的 `friend`
- [[Wiki/Entities/Stock/UNiagaraSystem]] — 容器
- [[Wiki/Concepts/Niagara/Niagara-cpu-vs-gpu模拟]] — `SimTarget` 字段是此分叉的根源
- [[Wiki/Concepts/Niagara/Niagara-vs-cascade]] — Emitter 继承 + merge 机制是相对 Cascade 的主要架构升级之一

## 与既有 wiki 的关系

- 印证了 [[Wiki/Concepts/Niagara/Niagara-vs-cascade]] 里提到的"`bInterpolatedSpawning` 是 Cascade 时代概念的延续"
- 印证了学习路径里 [[Wiki/Syntheses/Niagara/Niagara-learning-path]] 的 "UNiagaraEmitter 持有渲染器列表 + 脚本列表" 描述
