...
- [[Wiki/Entities/Stock/NiagaraEmitterInstanceBatcher]] — 本文件主类
- [[Wiki/Entities/Stock/FNiagaraGPUSystemTick]] — 被调度的 tick(Phase 8 详)
- [[Wiki/Entities/Stock/FNiagaraComputeExecutionContext]] — tick 里引用(Phase 8 详)
